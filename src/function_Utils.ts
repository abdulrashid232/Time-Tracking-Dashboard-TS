...
export let daily = document.querySelector(".daily") as HTMLElement;
export let weekly = document.querySelector(".weekly") as HTMLElement;
export let monthly = document.querySelector(".monthly") as HTMLElement;
